    ...
    companion object {
        ...
        suspend fun insertSampleProducts(context: Context) {
            ...
            val products = listOf(
                ...
                Product("F6", "Century Egg Pork ", 3.00, 7.00, 0, R.drawable.century_egg_and_pork_congee, "Breakfast", 100),
                ...
                Product("C8", "Spicy Pan Mee Soup", 4.00, 10.00,  0, R.drawable.hot___spicy_pan_mee_soup, "Chinese Food", 100),
                ...
                Product("W7", "Burger Special", 4.00, 9.00,  0, R.drawable.burger_chicken_special, "Western", 100),
